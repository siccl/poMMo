<script type="text/javascript" src="<?php echo($this->url['theme']['shared']); ?>js/jq/form.js"></script>
<script type="text/javascript" src="<?php echo($this->url['theme']['shared']); ?>js/jq/jqValidate.js"></script>
